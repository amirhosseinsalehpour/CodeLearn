...
export default function AuthTemplate({
  ...
  return (
    <div className="fade-in container pl-0 flex flex-col-reverse md:flex-row max-w-6xl dark:bg-base-50 mt-16 rounded-lg border dark:border-base-content dark:border-opacity-10 shadow-md dark:bg-opacity-20">
      ...
      <section className="flex-1 p-10 ">
        <div className="dark:bg-primary-focus rounded-lg  shadow-lg dark:text-white flex flex-col items-center justify-around text-center p-6">
          <h5 className="text-xl">کد لرن؛ آموزش متفاوت برنامه نویسی</h5>
