    ...
    >
      {counts.map((item) => (
        ...
        >
          ...
          <div className="h-10 bg-base-25 rounded-full  w-48 mb-4"></div>
          <div className="h-10 bg-base-50 rounded-full  mb-2.5"></div>
          <div className="h-10 bg-base-25 rounded-full mb-2.5"></div>
          <div className="h-10  bg-base-25 rounded-full"></div>
          <div className="flex items-center mt-4 space-x-3">
            <div>
              <div className="h-4 bg-base-25 rounded-full w-32 mb-2"></div>
              <div className="w-48 h-4 bg-base-25 rounded-full"></div>
            </div>
          </div>
        </div>
      ))}
